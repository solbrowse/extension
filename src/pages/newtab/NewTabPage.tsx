    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex flex-col sol-font-inter">
      ...
      <div className="flex-1 overflow-y-auto p-6 max-w-4xl mx-auto w-full pb-32">
        <MemoisedMessages
          ...
          onCopyMessage={(content: string, index: number) =>
            handleCopyMessage(content, index)
          }
          isStreaming={chatInput.isStreaming}
      ...
      <div className="sticky bottom-0 left-0 right-0 p-6 sol-ask-gradient-bg pt-12">
        <div className="max-w-4xl mx-auto">
          <div className="rounded-[20px] border-[0.5px] border-black/[0.07] sol-input-shadow sol-font-inter bg-white">
            <TabChipRow
              tabs={chatInput.selectedTabChips}
              onRemove={chatInput.handleTabRemoveById}
            />
